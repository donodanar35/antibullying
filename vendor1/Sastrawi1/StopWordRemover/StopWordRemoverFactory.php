...
class StopWordRemoverFactory
{
    ...
    public function getStopWords()
    {
        return array(
			...
			'kala','kalau','kalaulah','kalaupun','kalian','kami','kamilah','kamu','kamulah','kan','kapan','kapankah',
			...
			'sebaik-baiknya','sebaiknya','sebaliknya','sebanyak','sebegini','sebegitu','sebelum','sebelumnya',
			...
			'wong','yaitu','yakin','yakni','yang','selagi'
        );
    }
}
