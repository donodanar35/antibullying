...
class StopWordRemoverFactory
{
    public function createStopWordRemover()
    {
        ...
        return $stopWordRemover;
			...
			//kata sentimen
			//'ah','eh','waduh','alah','halah','hah','ha','heh','widih','woi',
			//'tidak','salah','biar','biarkan','biarlah','entar','sebentar',
			//'nanti','cocok','sesuai','aduh','sungguh','bah','wah','wow',
			//'beliau','ananda','ajudan','yth','ybs','mentang','oi','woy','woi',
			//'hmm','hmmm','hadeh','aduh','oom','sok','ananda','haduh','hoi',
			//'hadeh','waduh','aduh','wow','waw','melulu','idih','halah',
			//'halah','anda','andalah','woi',
    public function getStopWords()
    {
		//stopword list by Tala
        return array(
